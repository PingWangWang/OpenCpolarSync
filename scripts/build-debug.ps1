...
Write-Host "  OpenCpolarSync - Debug 编译" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# 2. NuGet 还原
# ============================================================
Write-Host "[2/3] NuGet 还原..." -ForegroundColor Yellow
...
# 3. 编译
# ============================================================
Write-Host "[3/3] 编译 ($Configuration)..." -ForegroundColor Yellow
